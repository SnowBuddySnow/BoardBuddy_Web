...
export default function UserTypeSelection({ onBack, onSelect }: UserTypeSelectionProps) {
    return (
        <div className="flex-1 flex flex-col h-full bg-[#F7F9FC] dark:bg-zinc-950 px-6 py-4">
            ...
            <main className="flex-1 flex flex-col justify-center py-8">
                ...
                <div className="grid grid-cols-2 gap-4">
                    <button
                        ...
                        className="min-h-64 rounded-3xl bg-[#DCEBFA] border-2 border-transparent p-5 flex flex-col items-center justify-between text-center shadow-sm transition hover:border-blue-500 hover:-translate-y-1 focus:outline-none focus:ring-2 focus:ring-blue-500"
                    >
                    ...
                    <button
                        ...
                        className="min-h-64 rounded-3xl bg-white border-2 border-zinc-100 p-5 flex flex-col items-center justify-between text-center shadow-sm transition hover:border-blue-500 hover:-translate-y-1 focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-zinc-900 dark:border-zinc-800"
                    >
                        <div className="w-full flex-1 flex items-center justify-center">
